...
**IMPORTANT**: Use **Layout A (Team Status Dashboard)** from SKILL.md. The exact section order is mandatory.

**React (Cowork/Claude Code):**

The dashboard should render as a single React component following Layout A:
...
├─────────────────────────────────────────────────────┤
│  KPI Cards (6 always):                               │
│  [Total Active] [In Progress] [In Review/QA]         │
│  [Blocked] [Unassigned] [Recently Completed]         │
├─────────────────────────────────────────────────────┤
│  Sprint Goals (if available)                         │
│  🎯 "Complete audit log v2" 🎯 "Ship PS 9.7.0-0"    │
├─────────────────────────────────────────────────────┤
